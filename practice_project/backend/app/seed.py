...
def seed():
    ...
    students = [
        Student(first_name="Ivan", last_name="Petrov", email="ivan@example.com",
                phone="+79161234567", group_id=groups[0].id, enrollment_date=date(2023, 9, 1)),
        Student(first_name="Maria", last_name="Sidorova", email="maria@example.com",
                phone="+79161234568", group_id=groups[0].id, enrollment_date=date(2023, 9, 1)),
        Student(first_name="Alexey", last_name="Ivanov", email="alex@example.com",
                phone="+79161234569", group_id=groups[1].id, enrollment_date=date(2023, 9, 1)),
        Student(first_name="Elena", last_name="Kozlova", email="elena@example.com",
                phone="+79161234570", group_id=groups[1].id, enrollment_date=date(2023, 9, 1)),
        Student(first_name="Dmitry", last_name="Smirnov", email="dmitry@example.com",
                phone="+79161234571", group_id=groups[2].id, enrollment_date=date(2022, 9, 1)),
        Student(first_name="Anna", last_name="Volkova", email="anna@example.com",
                phone="+79161234572", group_id=groups[2].id, enrollment_date=date(2022, 9, 1)),
        Student(first_name="Sergey", last_name="Morozov", email="sergey@example.com",
                phone="+79161234573", group_id=None, enrollment_date=date(2024, 9, 1)),
        Student(first_name="Olga", last_name="Novikova", email="olga@example.com",
                phone="+79161234574", group_id=None, enrollment_date=date(2024, 9, 1)),
        Student(first_name="Pavel", last_name="Fedorov", email="pavel@example.com",
                phone="+79161234575", group_id=groups[0].id, enrollment_date=date(2023, 9, 1)),
        Student(first_name="Natalia", last_name="Egorova", email="natalia@example.com",
